...
public class PlayerActivity extends AppCompatActivity
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    startAutoPlay = pref.getBoolean(KEY_AUTO_PLAY, true);
    startWindow = pref.getInt(KEY_WINDOW, -1);
    startPosition = pref.getLong(KEY_POSITION, -1);
  ...
  public void onPause() {
    ...
    editor.putBoolean(KEY_AUTO_PLAY, startAutoPlay);
    editor.putInt(KEY_WINDOW, startWindow);
    editor.putLong(KEY_POSITION, startPosition);
    editor.apply();
    // END - Code added by Robert Lukasevic
    if (Util.SDK_INT <= 23) {
      if (playerView != null) {
